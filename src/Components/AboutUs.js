...
Agents. </p>
      ...
      <ul>
        ...
        <li>Increase Household income and assets</li>
        <li>Increase Household food and nutritional security</li>
        <li>Environmental Protection</li>
      </ul>

      <ul>
        <h1>STRATEGIES</h1>
        <li>Holistic Women and Youth empowerment </li>
        <li>Enhancing Social capital</li>
